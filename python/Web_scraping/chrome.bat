...
dir /B /O-N "%PROGRAMFILES%/Google/Chrome/Application" | findstr "^[0-9]." > "chrome_version.txt"
...
echo ブラウザを起動する %PROGRAMFILES%=c:\PROGRA~1
echo "%PROGRAMFILES%\Google\Chrome\Application\chrome.exe" --remote-debugging-port=9222 --user-data-dir="C:\Users\igapo\temp"
start "" "%PROGRAMFILES%\Google\Chrome\Application\chrome.exe" --remote-debugging-port=9222 --user-data-dir="C:\Users\igapo\temp"
